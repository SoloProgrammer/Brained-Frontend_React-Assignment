...
function Login(props) {
    ...
    return (
        ...
        <small><h2 style={{"fontSize":"1.5em"}} className='text-center'> Welcome to  <img className="mx-2" style={{ width: "100px" }} src="https://th.bing.com/th/id/OIP.qDgIG5HKDZ_h1vi1FMoaYwAAAA?pid=ImgDet&w=256&h=256&rs=1" alt="cloud.png" /> App </h2></small>
            <div className="Box system-ui ">
                ...
                <div className="Box_box shadow">
                    ...
                    <p className='text-center f-bold orange'>Login to access NotesApp for free ,OR</p>
